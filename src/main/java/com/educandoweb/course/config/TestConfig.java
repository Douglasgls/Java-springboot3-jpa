...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User u1 = new User(null, "Douglas Paz", "douglas@gmail.com", "981765629", "123321");
        User u2 = new User(null, "Maria Silva", "maria@gmail.com", "123123123", "123");
        ...
        this.categorysRepository.saveAll(Arrays.asList(cat1,cat2,cat3));    
